...
static int caret_width = 4;                 /* -cw option; set default caret width */
...
static int min_width = 740;                 /* minimum width when centered */
#endif // CENTER_PATCH
#if BARPADDING_PATCH
...
{
        //	"SF Pro Display:style=Bold:size=10"
		  "JetBrainsMono Nerd Font:style=Bold:size=10"
		//  "Inter:style=Bold:size=13"
		//  "Geist Mono:size=13:style=Bold"
		// "Geist:size:13:style=Bold"
};
#endif // PANGO_PATCH
#if MANAGED_PATCH
...
static const unsigned int alphas[][3]      = {
	...
	#if BORDER_PATCH
	[SchemeBorder] = { borderalpha, borderalpha, borderalpha },
	#endif // BORDER_PATCH
	#if MORECOLOR_PATCH
...
char *colors[][2] = {
	/*               fg         bg       */
	[SchemeNorm] = { "#4f5163", "#000000" },
	[SchemeSel]  = { "#ffffff", "#000000" },
	[SchemeOut]  = { "#000000", "#000000" },
	#if BORDER_PATCH
	[SchemeBorder] = { "#000000", "#000000" },
	#endif // BORDER_PATCH
	#if MORECOLOR_PATCH
	[SchemeMid]  = { "#eeeeee", "#770000" },
	#endif // MORECOLOR_PATCH
	#if HIGHLIGHT_PATCH
	[SchemeSelHighlight]  = { "#9fc0d4", "#0a0a0a" },
	[SchemeNormHighlight] = { "#608da8", "#0a0a0a" },
	#endif // HIGHLIGHT_PATCH
	#if HIGHPRIORITY_PATCH
